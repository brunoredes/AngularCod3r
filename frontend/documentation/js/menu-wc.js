...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">angular_cod3r documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter modules">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            <li class="link">
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-60a99c45dbe0f6c57e49425a84194e4f"' : 'data-target="#xs-components-links-module-AppModule-60a99c45dbe0f6c57e49425a84194e4f"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-60a99c45dbe0f6c57e49425a84194e4f"' :
                                            'id="xs-components-links-module-AppModule-60a99c45dbe0f6c57e49425a84194e4f"' }>
                                            <li class="link">
                                ...
                                <li class="chapter inner">
                                    <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                        'data-target="#directives-links-module-AppModule-60a99c45dbe0f6c57e49425a84194e4f"' : 'data-target="#xs-directives-links-module-AppModule-60a99c45dbe0f6c57e49425a84194e4f"' }>
                                        <span class="icon ion-md-code-working"></span>
                                        <span>Directives</span>
                                        <span class="icon ion-ios-arrow-down"></span>
                                    </div>
                                    <ul class="links collapse" ${ isNormalMode ? 'id="directives-links-module-AppModule-60a99c45dbe0f6c57e49425a84194e4f"' :
                                        'id="xs-directives-links-module-AppModule-60a99c45dbe0f6c57e49425a84194e4f"' }>
                                        <li class="link">
                                            <a href="directives/RedDirective.html"
                                                data-type="entity-link" data-context="sub-entity" data-context-id="modules">RedDirective</a>
                                        </li>
                                    </ul>
                                </li>
                            </li>
                                ...
                                <a href="modules/ProductModule.html" data-type="entity-link">ProductModule</a>
                                    <li class="chapter inner">
                                        ...
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-ProductModule-e25be10a0b88fc8a7451ebe348db085c"' :
                                            ...
                                            <li class="link">
                                                <a href="components/ProductCancelButtonComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">ProductCancelButtonComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/ReadTableExampleComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">ReadTableExampleComponent</a>
                                            </li>
                                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            <li class="link">
                                <a href="classes/ReadTableExampleDataSource.html" data-type="entity-link">ReadTableExampleDataSource</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/ReadTableExampleItem.html" data-type="entity-link">ReadTableExampleItem</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
